...
5/25 두 달동안 프로젝트를 시작하기 위한 조원이 구성이 되었다.<br>
     ...
     <br>
    - 포트폴리오 작업은 트리 구성하는 것을 조언을 받았다.<br>
    - 그래도 애매한 것을 명확하게 어느 구역, 특징을 알게되니 조금씩 작성하면서 원하는 것이 나오기 시작했다.<br>
    - header, main 부분이 틀이 조금 생겨났으니 css, js도 찾아보고 활용하면 구성방향과는 비슷하게 만들어 질거 같다.<br>
    - 역시 시간이 촉박한게 고민거리다.
